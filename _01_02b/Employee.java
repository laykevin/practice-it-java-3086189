...
public class Employee {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("(Expected: 29)age: " + age);
    ...
    System.out.println("(Expected: true)isAManager: " + isAManager);
    ...
    System.out.println("(Expected: 2.5)yearsOfService: " + yearsOfService);
    ...
    System.out.println("(Expected: 3040)totalPayment: " + totalPayment);
    ...
    // thirdBonus.
    System.out.println("(Expected: 67.0)sum of variables: " + (firstBonus + secondBonus + thirdBonus));
  }
